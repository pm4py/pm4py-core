...
def construct(pn1, im1, fm1, pn2, im2, fm2, skip):
    ...
    '''
    sync_net = petri.net.PetriNet('synchronous_product_net of %s and %s' % (pn1.name, pn2.name))
    ...
    sync_im = petri.net.Marking()
    sync_fm = petri.net.Marking()
    for p in im1:
