...
from pm4py.objects.conversion.log.versions import to_event_stream, to_event_log, to_dataframe, from_dataframe
...
FROM_DATAFRAME = constants.TO_DATAFRAME
...
VERSIONS = {TO_TRACE_LOG: to_event_log.apply, TO_EVENT_LOG: to_event_log.apply, TO_EVENT_STREAM: to_event_stream.apply,
            ...
            FROM_DATAFRAME: from_dataframe.apply}
