...
class PetriNet(object):
    class Place(object):
        ...
        def __init__(self, name, in_arcs=None, out_arcs=None, properties=None):
            self.__name = name
            self.__in_arcs = SortedSet() if in_arcs is None else in_arcs
            self.__out_arcs = SortedSet() if out_arcs is None else out_arcs
    ...
    def __init__(self, name=None, places=None, transitions=None, arcs=None, properties=None):
        ...
        self.__places = SortedSet() if places is None else places
        self.__transitions = SortedSet() if transitions is None else transitions
        self.__arcs = SortedSet() if arcs is None else arcs
        self.__properties = dict() if properties is None else properties
