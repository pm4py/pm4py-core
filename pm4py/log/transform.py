...
def transform_event_log_to_trace_log(event_log, case_glue='case:concept:name', includes_case_attributes=True, case_attribute_prefix='case:'):
    traces = {}
    for event in event_log:
        ...
        if glue not in traces:
            ...
            traces[glue] = log_instance.Trace(trace_attr)
    ...
    return log_instance.TraceLog(event_log.attributes, traces.values())
