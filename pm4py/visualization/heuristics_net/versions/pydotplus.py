    ...
    for index, sa_list in enumerate(heu_net.start_activities):
        ...
        if effective_sa_list:
            ...
            for node_name in effective_sa_list:
                ...
                e = pydotplus.Edge(src=start_i, dst=sa, label=heu_net.net_name[index], color=heu_net.default_edges_color[index])
                graph.add_edge(e)
    ...
    for index, ea_list in enumerate(heu_net.end_activities):
        ...
        if effective_ea_list:
            ...
            for node_name in effective_ea_list:
                ...
                e = pydotplus.Edge(src=ea, dst=end_i, label=heu_net.net_name[index], color=heu_net.default_edges_color[index])
                graph.add_edge(e)
