...
def get_kde_date_attribute(values, parameters=None):
    ...
    if importlib.util.find_spec("scipy") and importlib.util.find_spec("numpy"):
        ...
        xs_transf = pandas_utils.dataframe_column_string_to_datetime(xs * 10 ** 9, utc=constants.ENABLE_DATETIME_COLUMNS_UTC, format=constants.DEFAULT_TIMESTAMP_PARSE_FORMAT)
