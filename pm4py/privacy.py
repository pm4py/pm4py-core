...
def anonymize_differential_privacy(log: Union[EventLog, pd.DataFrame], epsilon: float = 1.0, k: int = 10, p: int = 20) -> pd.DataFrame:
    ...
    Contextual-information, like timestamps and resources, is anonymized with PRIPEL. This technique enriches a control-flow anonymized event log with contextual information, while still achieving differential privacy.
