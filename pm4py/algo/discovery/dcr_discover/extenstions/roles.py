...
class Role_Mining:
    def role_assignment_role_to_acitivity(self, G: Dict[str, Dict[str, Set[str]]], log: pd.DataFrame, activity_key: str,
                                          group_key: str) -> None:
        """
        If log has defined roles, mine for role assignment using the role identifier
    ...
    def role_assignment_resource_to_acitivity(self, G: Dict[str, Dict[str, Set[str]]], log: pd.DataFrame, activity_key: str,
                                              resource_key: str) -> None:
        """
        if log has no role defined roles, only resource, mine for role assignment using resource identifier
