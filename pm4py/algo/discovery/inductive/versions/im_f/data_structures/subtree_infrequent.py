...
from pm4py.algo.discovery.inductive.versions.im.util import base_case
...
from pm4py.algo.discovery.inductive.versions.im_f import splitting_infrequent, fall_through_infrequent
from pm4py.algo.discovery.inductive.versions.im.util import fall_through
