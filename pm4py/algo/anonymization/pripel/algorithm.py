...
def apply(log: Union[EventLog, pd.DataFrame], traceVariantQuery: EventLog, variant=DEFAULT_VARIANT,
    ...
    return exec_utils.get_variant(variant).apply(log, traceVariantQuery, parameters=parameters)
