...
def read_xes(file_path: str, variant: str = "lxml", return_log_object: bool = False, **kwargs) -> DataFrame:
    """
    ...
    :param return_log_object: boolean value enabling returning a log object (default: False)
    :rtype: ``DataFrame``
