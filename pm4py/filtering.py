...
def filter_log_relative_occurrence_event_attribute(log: Union[EventLog, pd.DataFrame], min_relative_stake: float, attribute_key : str = xes_constants.DEFAULT_NAME_KEY, level="cases", timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> Union[EventLog, pd.DataFrame]:
    """
    ...
    parameters = get_properties(log, timestamp_key=timestamp_key, case_id_key=case_id_key, **kwargs)
...
def filter_start_activities(log: Union[EventLog, pd.DataFrame], activities: Union[Set[str], List[str]], retain: bool = True, activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> \
...
def filter_end_activities(log: Union[EventLog, pd.DataFrame], activities:  Union[Set[str], List[str]], retain: bool = True, activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> Union[
...
def filter_event_attribute_values(log: Union[EventLog, pd.DataFrame], attribute_key: str, values:  Union[Set[str], List[str]],
                                  level: str = "case", retain: bool = True, case_id_key: Optional[str] = None, **kwargs) -> Union[EventLog, pd.DataFrame]:
    """
...
def filter_trace_attribute_values(log: Union[EventLog, pd.DataFrame], attribute_key: str, values:  Union[Set[str], List[str]],
                                  retain: bool = True, case_id_key: Optional[str] = None, **kwargs) -> Union[EventLog, pd.DataFrame]:
    """
...
def filter_variants(log: Union[EventLog, pd.DataFrame], variants:  Union[Set[str], List[str]], retain: bool = True, activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> Union[
    EventLog, pd.DataFrame]:
    """
...
def filter_directly_follows_relation(log: Union[EventLog, pd.DataFrame], relations: List[str], retain: bool = True, activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> \
        Union[EventLog, pd.DataFrame]:
    """
...
def filter_eventually_follows_relation(log: Union[EventLog, pd.DataFrame], relations: List[str], retain: bool = True, activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> \
        Union[EventLog, pd.DataFrame]:
    """
...
def filter_time_range(log: Union[EventLog, pd.DataFrame], dt1: str, dt2: str, mode="events", timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> Union[
    EventLog, pd.DataFrame]:
    """
    ...
    properties = get_properties(log, timestamp_key=timestamp_key, case_id_key=case_id_key, **kwargs)
    if check_is_pandas_dataframe(log):
...
def filter_between(log: Union[EventLog, pd.DataFrame], act1: str, act2: str, activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> Union[EventLog, pd.DataFrame]:
    """
...
def filter_case_size(log: Union[EventLog, pd.DataFrame], min_size: int, max_size: int, case_id_key: Optional[str] = None, **kwargs) -> Union[EventLog, pd.DataFrame]:
    """
...
def filter_case_performance(log: Union[EventLog, pd.DataFrame], min_performance: float, max_performance: float, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> Union[EventLog, pd.DataFrame]:
    """
...
def filter_activities_rework(log: Union[EventLog, pd.DataFrame], activity: str, min_occurrences: int = 2, activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> Union[EventLog, pd.DataFrame]:
    """
...
def filter_paths_performance(log: Union[EventLog, pd.DataFrame], path: Tuple[str, str], min_performance: float, max_performance: float, keep=True, activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> Union[EventLog, pd.DataFrame]:
    """
...
def filter_variants_top_k(log: Union[EventLog, pd.DataFrame], k: int, activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> Union[EventLog, pd.DataFrame]:
    """
...
def filter_variants_by_coverage_percentage(log: Union[EventLog, pd.DataFrame], min_coverage_percentage: float, activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs) -> Union[EventLog, pd.DataFrame]:
    """
...
def filter_prefixes(log: Union[EventLog, pd.DataFrame], activity: str, strict=True, first_or_last="first", activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs):
    """
...
def filter_suffixes(log: Union[EventLog, pd.DataFrame], activity: str, strict=True, first_or_last="first", activity_key: Optional[str] = None, timestamp_key: Optional[str] = None, case_id_key: Optional[str] = None, **kwargs):
    """
