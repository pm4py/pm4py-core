...
RUN pip install pydotplus==2.0.2 pulp==1.6.10 sklearn intervaltree==3.0.2
RUN pip install ortools==7.4.7247 prefixspan==0.5.2 fasttext==0.9.1 pybind11==2.4.3 pyarrow==0.15.1
COPY . /app
