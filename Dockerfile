...
RUN pip install backcall==0.2.0 colorama==0.4.4 cycler==0.10.0 decorator==5.0.9 deprecation==2.1.0 graphviz==0.16 intervaltree==3.1.0 ipython==7.25.0 ipython-genutils==0.2.0 jedi==0.18.0 jinja2==3.0.1 joblib==1.0.1 jsonpickle==2.0.0 kiwisolver==1.3.1 lxml==4.6.3 MarkupSafe==2.0.1 matplotlib==3.4.2 matplotlib-inline==0.1.2 mpmath==1.2.1 networkx==2.6rc2 numpy==1.21.0 packaging==21.0 pandas==1.3.0 parso==0.8.2 pickleshare==0.7.5 pillow==8.3.1 prompt-toolkit==3.0.19 pulp==2.4 pydotplus==2.0.2 pygments==2.9.0 pyparsing==3.0.0b2 python-dateutil==2.8.1 pytz==2021.1 pyvis==0.1.9 scikit-learn==0.24.2 scipy==1.7.0 setuptools==57.1.0 six==1.16.0 sortedcontainers==2.4.0 stringdist==1.0.9 sympy==1.8 threadpoolctl==2.1.0 tqdm==4.61.2 traitlets==5.0.5 wcwidth==0.2.5
