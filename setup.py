...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.clustering.hierarchical_attribute_based',
              'pm4py.algo.clustering.hierarchical_attribute_based.dfg',
              'pm4py.algo.clustering.hierarchical_attribute_based.util',
              'pm4py.algo.clustering.hierarchical_attribute_based.variant',
              'pm4py.algo.clustering.hierarchical_attribute_based.merge_log',
              'pm4py.algo.clustering.hierarchical_attribute_based.leven_dist',
              'pm4py.algo.clustering.hierarchical_attribute_based.linkage_method', 'pm4py.algo.simulation',
              ...
              'pm4py.algo.enhancement.roles.versions', 'pm4py.algo.enhancement.comparison',
              'pm4py.algo.enhancement.comparison.petrinet', 'pm4py.util', 'pm4py.util.lp', 'pm4py.util.lp.util',
              'pm4py.util.lp.versions', 'pm4py.util.dt_parsing', 'pm4py.util.dt_parsing.versions', 'pm4py.objects',
              'pm4py.objects.dfg', 'pm4py.objects.dfg.utils', 'pm4py.objects.dfg.filtering',
              'pm4py.objects.dfg.retrieval', 'pm4py.objects.log', 'pm4py.objects.log.util',
