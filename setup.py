...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.objects.log.importer.xes.variants', 'pm4py.objects.petri', 'pm4py.objects.petri.common',
              ...
              'pm4py.objects.conversion.log.variants', 'pm4py.objects.conversion.wf_net',
              ...
              'pm4py.statistics.performance_spectrum', 'pm4py.statistics.performance_spectrum.variants',
              'pm4py.visualization', 'pm4py.visualization.dfg', 'pm4py.visualization.dfg.variants',
              'pm4py.visualization.sna', 'pm4py.visualization.sna.variants', 'pm4py.visualization.common',
              ...
              'pm4py.visualization.decisiontree', 'pm4py.visualization.decisiontree.variants',
