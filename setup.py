...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.enhancement.sna', 'pm4py.algo.enhancement.sna.metrics', 'pm4py.algo.enhancement.sna.metrics.handover',
              'pm4py.algo.enhancement.sna.metrics.handover.versions', 'pm4py.algo.enhancement.sna.metrics.real_handover',
              'pm4py.algo.enhancement.sna.metrics.real_handover.versions', 'pm4py.algo.enhancement.sna.metrics.similar_activities',
              'pm4py.algo.enhancement.sna.metrics.similar_activities.versions', 'pm4py.algo.enhancement.sna.transformer',
              'pm4py.algo.enhancement.sna.transformer.common', 'pm4py.algo.enhancement.sna.transformer.pandas',
              'pm4py.algo.enhancement.sna.transformer.pandas.versions', 'pm4py.algo.enhancement.sna.transformer.tracelog',
              'pm4py.algo.enhancement.sna.transformer.tracelog.versions', 'pm4py.algo.simulation', 'pm4py.algo.simulation.simple',
              ...
              'pm4py.algo.simulation.simple.filtering.tracelog', 'pm4py.algo.simulation.simple.filtering.tracelog.versions',
              'pm4py.algo.simulation.playout', 'pm4py.algo.simulation.playout.versions',
              'pm4py.algo.simulation.playout.data_structures', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
