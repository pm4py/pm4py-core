...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.objects.conversion.log.variants', 'pm4py.objects.conversion.process_tree',
              ...
              'pm4py.streaming.algo.discovery', 'pm4py.streaming.algo.conformance',
              ...
              'pm4py.statistics.passed_time.pandas.variants', 'pm4py.statistics.end_activities',
              ...
              'pm4py.statistics.performance_spectrum.variants', 'pm4py.visualization', 'pm4py.visualization.dfg',
