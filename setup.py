...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.merging', 'pm4py.algo.merging.case_relations',
              ...
              'pm4py.algo.discovery.ocel.ocdfg.variants', 'pm4py.algo.discovery.ocel.saw_nets',
              'pm4py.algo.discovery.ocel.saw_nets.variants', 'pm4py.algo.discovery.ocel.interleavings',
