...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.stream', 'pm4py.algo.stream.tasks', 'pm4py.algo.stream.tasks.versions',
              'pm4py.algo.stream.grouping', 'pm4py.algo.stream.grouping.versions', 'pm4py.algo.stream.task_mining',
              'pm4py.algo.stream.task_mining.versions', 'pm4py.algo.stream.sequence_mining',
              'pm4py.algo.stream.sequence_mining.versions', 'pm4py.algo.stream.sequence_scoring',
              'pm4py.algo.stream.sequence_clustering', 'pm4py.algo.stream.sequence_clustering.versions',
