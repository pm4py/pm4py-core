...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.merging', 'pm4py.algo.merging.case_relations',
              ...
              'pm4py.algo.discovery.inductive.variants', 'pm4py.algo.discovery.inductive.variants.im_clean',
              ...
              'pm4py.algo.filtering.pandas.attributes', 'pm4py.algo.filtering.pandas.starts_with',
