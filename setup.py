...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.conformance', 'pm4py.algo.conformance.pt_regex', 'pm4py.algo.conformance.pt_regex.versions',
              ...
              'pm4py.algo.enhancement.roles.common', 'pm4py.algo.enhancement.roles.versions', 'pm4py.algo.task_mining',
              'pm4py.algo.task_mining.tasks', 'pm4py.algo.task_mining.tasks.versions',
              'pm4py.algo.task_mining.grouping', 'pm4py.algo.task_mining.grouping.versions',
              'pm4py.algo.task_mining.versions', 'pm4py.algo.task_mining.sequence_mining',
              'pm4py.algo.task_mining.sequence_mining.versions', 'pm4py.algo.task_mining.sequence_scoring',
              'pm4py.algo.task_mining.sequence_clustering', 'pm4py.algo.task_mining.sequence_clustering.versions',
              'pm4py.algo.performance_analysis', 'pm4py.algo.performance_analysis.bipartite_matching',
              'pm4py.algo.performance_analysis.bipartite_matching.util',
              'pm4py.algo.performance_analysis.bipartite_matching.versions', 'pm4py.util', 'pm4py.util.lp',
              'pm4py.util.lp.util', 'pm4py.util.lp.versions', 'pm4py.objects', 'pm4py.objects.dfg',
              'pm4py.objects.dfg.utils', 'pm4py.objects.dfg.filtering', 'pm4py.objects.log', 'pm4py.objects.log.util',
