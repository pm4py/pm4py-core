...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.sna', 'pm4py.algo.sna.metrics', 'pm4py.algo.sna.metrics.handover',
              'pm4py.algo.sna.metrics.handover.versions', 'pm4py.algo.sna.metrics.real_handover',
              'pm4py.algo.sna.metrics.real_handover.versions', 'pm4py.algo.sna.metrics.similar_activities',
              'pm4py.algo.sna.metrics.similar_activities.versions', 'pm4py.algo.sna.transformer',
              'pm4py.algo.sna.transformer.common', 'pm4py.algo.sna.transformer.pandas',
              'pm4py.algo.sna.transformer.pandas.versions', 'pm4py.algo.sna.transformer.tracelog',
              'pm4py.algo.sna.transformer.tracelog.versions', 'pm4py.algo.other', 'pm4py.algo.other.simple',
              'pm4py.algo.other.simple.model', 'pm4py.algo.other.simple.model.pandas',
              'pm4py.algo.other.simple.model.pandas.versions', 'pm4py.algo.other.simple.model.tracelog',
              'pm4py.algo.other.simple.model.tracelog.versions', 'pm4py.algo.other.simple.filtering',
              'pm4py.algo.other.simple.filtering.pandas', 'pm4py.algo.other.simple.filtering.pandas.versions',
              'pm4py.algo.other.simple.filtering.tracelog', 'pm4py.algo.other.simple.filtering.tracelog.versions',
              'pm4py.algo.other.playout', 'pm4py.algo.other.playout.versions',
              'pm4py.algo.other.playout.data_structures', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.conformance.tokenreplay.diagnostics', 'pm4py.util', 'pm4py.objects', 'pm4py.objects.log',
              ...
              'pm4py.objects.log.importer.xes', 'pm4py.objects.log.importer.xes.versions', 'pm4py.objects.sna',
              'pm4py.objects.petri', 'pm4py.objects.petri.common', 'pm4py.objects.petri.exporter',
              'pm4py.objects.petri.importer', 'pm4py.objects.conversion', 'pm4py.objects.conversion.tree_to_petri',
