...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.merging', 'pm4py.algo.merging.case_relations',
              ...
              'pm4py.algo.discovery.declare', 'pm4py.algo.discovery.declare.variants', 'pm4py.algo.discovery.inductive',
              'pm4py.algo.discovery.inductive.cuts', 'pm4py.algo.discovery.inductive.dtypes',
              'pm4py.algo.discovery.inductive.variants', 'pm4py.algo.discovery.inductive.base_case',
              'pm4py.algo.discovery.inductive.fall_through', 'pm4py.algo.discovery.footprints',
              ...
              'pm4py.algo.conformance', 'pm4py.algo.conformance.declare', 'pm4py.algo.conformance.declare.variants',
              ...
              'pm4py.algo.transformation.ocel.split_ocel.variants', 'pm4py.algo.transformation.ocel.description',
              'pm4py.algo.transformation.ocel.description.variants', 'pm4py.algo.transformation.log_to_trie',
              ...
              'pm4py.objects.ocel.importer.jsonocel.variants', 'pm4py.objects.ocel.validation', 'pm4py.objects.powl',
              'pm4py.objects.trie', 'pm4py.objects.petri_net', 'pm4py.objects.petri_net.utils',
              'pm4py.objects.petri_net.saw_net', 'pm4py.objects.petri_net.exporter',
              'pm4py.objects.petri_net.exporter.variants', 'pm4py.objects.petri_net.importer',
              'pm4py.objects.petri_net.importer.variants', 'pm4py.objects.petri_net.stochastic',
              ...
              'pm4py.objects.conversion.ocel.variants', 'pm4py.objects.conversion.powl',
              'pm4py.objects.conversion.powl.variants', 'pm4py.objects.conversion.wf_net',
              ...
              'pm4py.statistics.eventually_follows.uvcl', 'pm4py.statistics.eventually_follows.pandas',
              ...
              'pm4py.visualization.dfg.util', 'pm4py.visualization.dfg.variants', 'pm4py.visualization.sna',
              'pm4py.visualization.sna.variants', 'pm4py.visualization.bpmn', 'pm4py.visualization.bpmn.variants',
              'pm4py.visualization.ocel', 'pm4py.visualization.ocel.ocpn', 'pm4py.visualization.ocel.ocpn.variants',
              ...
              'pm4py.visualization.powl', 'pm4py.visualization.powl.variants', 'pm4py.visualization.trie',
