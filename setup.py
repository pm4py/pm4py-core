...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.sna', 'pm4py.algo.sna.metrics', 'pm4py.algo.sna.metrics.handover',
              ...
              'pm4py.objects.petri.importer', 'pm4py.objects.conversion', 'pm4py.objects.conversion.process_tree',
              'pm4py.objects.conversion.process_tree.versions', 'pm4py.objects.process_tree',
