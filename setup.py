...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.sna', 'pm4py.algo.sna.metrics', 'pm4py.algo.sna.metrics.handover',
              ...
              'pm4py.objects.process_tree.trace_generation', 'pm4py.objects.random_variables',
              ...
              'pm4py.objects.stochastic_petri', 'pm4py.objects.transition_system', 'pm4py.evaluation',
              'pm4py.evaluation.precision', 'pm4py.evaluation.precision.versions', 'pm4py.evaluation.simplicity',
