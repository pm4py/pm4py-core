...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.enhancement.roles.versions', 'pm4py.algo.task_mining', 'pm4py.algo.task_mining.tasks',
              'pm4py.algo.task_mining.tasks.versions', 'pm4py.algo.task_mining.grouping',
              'pm4py.algo.task_mining.grouping.versions', 'pm4py.algo.task_mining.versions',
              'pm4py.algo.task_mining.sequence_mining', 'pm4py.algo.task_mining.sequence_mining.versions',
              'pm4py.algo.task_mining.sequence_scoring', 'pm4py.algo.task_mining.sequence_clustering',
              'pm4py.algo.task_mining.sequence_clustering.versions', 'pm4py.algo.performance_analysis',
              'pm4py.algo.performance_analysis.bipartite_matching',
