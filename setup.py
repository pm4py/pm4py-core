...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.analysis', 'pm4py.algo.analysis.woflan',
              ...
              'pm4py.algo.conformance.alignments.petri_net.algorithm', 'pm4py.algo.conformance.alignments.decomposed',
              ...
              'pm4py.algo.conformance.logs_alignments.variants', 'pm4py.algo.conformance.tree_alignments',
              'pm4py.algo.conformance.tree_alignments.util', 'pm4py.algo.conformance.tree_alignments.variants',
              ...
              'pm4py.algo.transformation.log_to_trie', 'pm4py.util', 'pm4py.util.lp', 'pm4py.util.lp.util',
              'pm4py.util.lp.variants', 'pm4py.util.dt_parsing', 'pm4py.util.dt_parsing.variants', 'pm4py.objects',
              'pm4py.objects.dfg', 'pm4py.objects.dfg.utils', 'pm4py.objects.dfg.exporter',
