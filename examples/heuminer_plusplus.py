...
def execute_script():
    ...
    df["start_timestamp"] = pandas_utils.dataframe_column_string_to_datetime(df["start_timestamp"], utc=constants.ENABLE_DATETIME_COLUMNS_UTC, format=constants.DEFAULT_XES_TIMESTAMP_PARSE_FORMAT)
