...
class TestDcr(unittest.TestCase):
    ...
    def test_dcr_js_portal(self):
        dcr = import_apply(os.path.join("test_output_data", "sepsis_dcr_portal.xml"))
        path = "C:/Users/herma/Downloads/sepsis_dcr_js_portal.xml"
        export_apply(dcr_graph=dcr,path=path,variant=dcr_exporter.DCR_JS_PORTAL, dcr_title='sepsis_dcr_portal_exported_xml')
