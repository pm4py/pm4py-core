...
class PetriImportExportTest(unittest.TestCase):
    ...
    def test_importingExportingStochasticNet(self):
        ...
        petri_exporter.export_net(imported_petri1, marking1, os.path.join(OUTPUT_DATA_DIR, "stochastic_running_example.pnml"), final_marking=fmarking1, stochastic_map=stochastic_info1)
