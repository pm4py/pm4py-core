...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.other', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.enhancement.sna.transformer.tracelog.versions', 'pm4py.util', 'pm4py.util.lp',
              'pm4py.util.lp.util', 'pm4py.util.lp.versions', 'pm4py.util.ilp', 'pm4py.util.ilp.versions',
