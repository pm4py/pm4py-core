...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.objects.conversion.heuristics_net.versions', 'pm4py.objects.event_store',
              'pm4py.objects.event_store.utils', 'pm4py.objects.event_store.versions', 'pm4py.objects.process_tree',
