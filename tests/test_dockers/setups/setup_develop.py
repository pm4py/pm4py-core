...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.other', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.filtering.tracelog.start_activities', 'pm4py.algo.simulation', 'pm4py.algo.discovery.simple',
              ...
              'pm4py.algo.discovery.simple.filtering.tracelog.versions', 'pm4py.algo.simulation.playout',
              ...
              'pm4py.algo.enhancement', 'pm4py.util', 'pm4py.util.lp', 'pm4py.util.lp.util', 'pm4py.util.lp.versions',
              ...
              'pm4py.objects.conversion.log', 'pm4py.objects.conversion.log.versions',
