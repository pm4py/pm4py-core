...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.other', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.discovery.simple.model.pandas.versions', 'pm4py.algo.discovery.simple.model.tracelog',
              'pm4py.algo.discovery.simple.model.tracelog.versions', 'pm4py.algo.discovery.simple.filtering',
              'pm4py.algo.discovery.simple.filtering.pandas', 'pm4py.algo.discovery.simple.filtering.pandas.versions',
              'pm4py.algo.discovery.simple.filtering.tracelog',
              'pm4py.algo.discovery.simple.filtering.tracelog.versions', 'pm4py.algo.discovery.inductive',
              ...
              'pm4py.algo.filtering.tracelog.start_activities', 'pm4py.algo.simulation',
