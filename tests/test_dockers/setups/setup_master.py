...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.other', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.discovery.simple.model', 'pm4py.algo.discovery.simple.model.pandas',
              'pm4py.algo.discovery.simple.model.pandas.versions', 'pm4py.algo.discovery.simple.model.log',
              'pm4py.algo.discovery.simple.model.log.versions', 'pm4py.algo.discovery.simple.filtering',
              'pm4py.algo.discovery.simple.filtering.pandas', 'pm4py.algo.discovery.simple.filtering.pandas.versions',
              'pm4py.algo.discovery.simple.filtering.log',
              'pm4py.algo.discovery.simple.filtering.log.versions', 'pm4py.algo.discovery.inductive',
              ...
              'pm4py.algo.filtering.log', 'pm4py.algo.filtering.log.cases',
              ...
              'pm4py.algo.filtering.log.start_activities', 'pm4py.algo.simulation',
              ...
              'pm4py.algo.conformance.tokenreplay.diagnostics', 'pm4py.algo.enhancement', 'pm4py.util', 'pm4py.util.lp',
              'pm4py.util.lp.util', 'pm4py.util.lp.versions', 'pm4py.objects', 'pm4py.objects.log',
              ...
              'pm4py.statistics.traces.common', 'pm4py.statistics.traces.pandas', 'pm4py.statistics.traces.log',
              ...
              'pm4py.visualization.process_tree.versions', 'pm4py.visualization.transition_system',
