...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.other', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.algo.discovery.simple.model.log.versions', 'pm4py.algo.discovery.simple.model.pandas',
              'pm4py.algo.discovery.simple.model.pandas.versions', 'pm4py.algo.discovery.simple.filtering',
