...
cd ..
cd python38
docker build --no-cache -t testdockerlinuxpython38develop .
docker run testdockerlinuxpython38develop bash -c "cd pm4py-source-develop/tests && python execute_tests.py"
docker run testdockerlinuxpython38develop bash -c "python -c \"import pm4py ; print(pm4py.__version__)\""
