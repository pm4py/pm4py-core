...
from tests.documentation_tests.testDocAlpha1 import AlphaMinerDocumentationTest
from tests.documentation_tests.testDocInductive1 import InductiveMinerDocumentationTest
from tests.documentation_tests.testDocDfGraph1 import DfGraphDocumentationTest
from tests.documentation_tests.testDocXes1 import XES1DocumentationTest
from tests.documentation_tests.testDocCsv1 import CSV1DocumentationTest
from tests.documentation_tests.testDocClassifiers1 import Classifiers1DocumentationTest
from tests.documentation_tests.testDocMeasures import DocMeasuresDocumentationTest
