...
class SimplifiedInterfaceTest(unittest.TestCase):
    ...
    def test_statistics_df(self):
        ...
        df["Timestamp"] = pandas_utils.dataframe_column_string_to_datetime(df["Timestamp"], utc="True", format="ISO8601")
    ...
    def test_rebase(self):
        ...
        dataframe["Timestamp"] = pandas_utils.dataframe_column_string_to_datetime(dataframe["Timestamp"], utc=True, format="ISO8601")
    ...
    def test_filter_act_done_diff_res_df(self):
        dataframe = pd.read_csv("input_data/running-example-transformed.csv")
        dataframe["Timestamp"] = pandas_utils.dataframe_column_string_to_datetime(dataframe["Timestamp"], utc=True)
        dataframe["CaseID"] = dataframe["CaseID"].astype("string")
